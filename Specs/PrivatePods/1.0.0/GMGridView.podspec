...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HrishiPol/GMGridView"
  ...
  s.author             = { "HrishiPol" => "email@address.com" }
  # Or just: s.author    = "HrishiPol"
  # s.authors            = { "HrishiPol" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/HrishiPol"
  ...
  s.source       = { :git => "https://github.com/HrishiPol/GMGridView.git", :tag => "v1.1.1" }
